...
export default {
  title: 'Overview/Bellite/04 Project Structure',
  parameters: {
    layout: 'padded',
  },
};
...
const DESCRIPTIONS = {
  // Data
  landingPageContent: 'Data · 섹션 카피와 약속·장면·수납·오브제 레코드',
  mediaAssets: 'Data · 구간별 사진·영상 매핑과 파일명 맵',
  componentTokenMap: 'Data · 컴포넌트와 디자인 토큰 매핑',
  layoutTaxonomyData: 'Data · 레이아웃 아키타입 분류 데이터',
...
/**
 * 트리 노드를 TreeNode 가 받을 수 있는 중첩 객체로 변환한다.
...
function nodeToTree(node) {
  ...
  for (const child of node.children || []) {
    // Context/Provider는 설명만 남기고 하위 탐색을 멈춘다
